...
button_addin = Button(root, text="+", padx=39, pady=20, command=button_addin).grid(row=5, column=0)
button_equal = Button(root, text="=", padx=90, pady=20, command=button_equal).grid(row=5, column=1, columnspan=2)
...
button_mult = Button(root, text="x", padx=40, pady=20, command=button_mult).grid(row=6, column=1)
button_dev = Button(root, text="÷", padx=41, pady=20, command=button_dev).grid(row=6, column=2)
